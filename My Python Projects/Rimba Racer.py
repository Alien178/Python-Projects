...
pygame.display.set_caption('Rimba Racer')
...
def crash():
    ...
    while True:
        ...
        button("Play Agian",150,450,100,50,green,bright_green,game_loop)
...
def game_intro():
    ...
    while intro:
        ...
        gameDisplay.fill(white)
        largeText = pygame.font.SysFont('comicsansms',115)
        TextSurf, TextRect = text_objects("Rimba Racer", largeText)
        TextRect.center = ((display_width/2),(display_height/2))
        gameDisplay.blit(TextSurf, TextRect)
